...
class SushiGoClient:
    def __init__(self, host: str, port: int):
        ...
        # --- Efficient Generalist Priorities ---
        # Focuses on high Points-Per-Card (PPC) and guaranteed scoring
        self.PRIORITIES = {
            (1, "early"): ["Squid Nigiri", "Wasabi", "Salmon Nigiri", "Tempura", "Maki Roll (3)", "Dumpling",
                           "Pudding", "Sashimi", "Maki Roll (2)", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (1, "mid"): ["Squid Nigiri", "Tempura", "Salmon Nigiri", "Wasabi", "Maki Roll (3)", "Dumpling",
                         "Pudding", "Sashimi", "Maki Roll (2)", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (1, "late"): ["Squid Nigiri", "Salmon Nigiri", "Tempura", "Dumpling", "Maki Roll (3)", "Maki Roll (2)",
                          "Pudding", "Sashimi", "Wasabi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "early"): ["Squid Nigiri", "Wasabi", "Salmon Nigiri", "Pudding", "Maki Roll (3)", "Tempura",
                           "Dumpling", "Maki Roll (2)", "Sashimi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "mid"): ["Squid Nigiri", "Salmon Nigiri", "Pudding", "Wasabi", "Tempura", "Maki Roll (3)",
                         "Maki Roll (2)", "Dumpling", "Sashimi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "late"): ["Squid Nigiri", "Salmon Nigiri", "Pudding", "Tempura", "Dumpling", "Maki Roll (3)",
                          "Maki Roll (2)", "Sashimi", "Wasabi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (3, "early"): ["Pudding", "Squid Nigiri", "Wasabi", "Salmon Nigiri", "Maki Roll (3)", "Tempura",
                           "Dumpling", "Maki Roll (2)", "Sashimi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (3, "mid"): ["Pudding", "Squid Nigiri", "Salmon Nigiri", "Wasabi", "Dumpling", "Maki Roll (3)",
                         "Tempura", "Maki Roll (2)", "Sashimi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
    ...
    def choose_card(self, hand: list[str]) -> int:
        ...
        # Wasabi / Nigiri logic: Prioritize finishing Wasabi sets immediately
        ...
        # Completion (Tempura/Sashimi): Only force completion if it provides higher guaranteed value
        if phase in ("mid", "late"):
            # Sashimi is a 10pt set, Tempura is a 5pt set
