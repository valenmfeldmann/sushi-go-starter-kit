...
class SushiGoClient:
    def __init__(self, host: str, port: int):
        ...
        # --- Pudding Power Priorities ---
        # Aggressively secures Pudding to guarantee a +6 bonus and avoid a -6 penalty
        self.PRIORITIES = {
            (1, "early"): ["Pudding", "Squid Nigiri", "Wasabi", "Salmon Nigiri", "Tempura", "Maki Roll (3)", "Dumpling",
                           "Sashimi", "Maki Roll (2)", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (1, "mid"): ["Squid Nigiri", "Tempura", "Pudding", "Salmon Nigiri", "Wasabi", "Maki Roll (3)", "Dumpling",
                         "Sashimi", "Maki Roll (2)", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (1, "late"): ["Squid Nigiri", "Salmon Nigiri", "Tempura", "Pudding", "Dumpling", "Maki Roll (3)",
                          "Maki Roll (2)", "Sashimi", "Wasabi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "early"): ["Pudding", "Squid Nigiri", "Wasabi", "Salmon Nigiri", "Maki Roll (3)", "Maki Roll (2)",
                           "Tempura", "Sashimi", "Dumpling", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "mid"): ["Pudding", "Squid Nigiri", "Salmon Nigiri", "Wasabi", "Tempura", "Maki Roll (3)",
                         "Maki Roll (2)", "Dumpling", "Sashimi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (2, "late"): ["Pudding", "Squid Nigiri", "Salmon Nigiri", "Tempura", "Dumpling", "Maki Roll (3)",
                          "Maki Roll (2)", "Sashimi", "Wasabi", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
            (3, "early"): ["Pudding", "Squid Nigiri", "Wasabi", "Salmon Nigiri", "Maki Roll (3)", "Maki Roll (2)",
                           "Tempura", "Sashimi", "Dumpling", "Egg Nigiri", "Maki Roll (1)", "Chopsticks"],
    ...
    def choose_card(self, hand: list[str]) -> int:
        ...
        # Completion logic for Sashimi/Tempura
