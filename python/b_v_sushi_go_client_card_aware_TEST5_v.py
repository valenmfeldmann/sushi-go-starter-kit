...
class SushiGoClient:
    def __init__(self, host: str, port: int):
        ...
        # --- Chopsticks Engine Priorities ---
        # Prioritizes early-round flexibility to secure high-value combos later
        self.PRIORITIES = {
            (1, "early"): ["Chopsticks", "Squid Nigiri", "Wasabi", "Salmon Nigiri", "Tempura", "Maki Roll (3)", "Dumpling",
                           "Pudding", "Sashimi", "Maki Roll (2)", "Egg Nigiri", "Maki Roll (1)"],
            ...
            (2, "early"): ["Chopsticks", "Wasabi", "Squid Nigiri", "Salmon Nigiri", "Maki Roll (3)", "Maki Roll (2)",
                           "Tempura", "Sashimi", "Dumpling", "Pudding", "Egg Nigiri", "Maki Roll (1)"],
